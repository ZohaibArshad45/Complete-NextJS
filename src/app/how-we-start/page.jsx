...
const HowWeStart = () => {
    return (
        <div className=" flex flex-col items-center bg-gray-50 p-6">
            <h1 className="text-4xl font-extrabold text-blue-600 mb-6">🚀 How We Start</h1>
            ...
            <div className="bg-gray-900 text-white font-mono text-lg p-4 rounded-lg shadow-md mt-4">
            ...
            <div className="bg-gray-900 text-white font-mono text-lg p-4 rounded-lg shadow-md mt-2">
